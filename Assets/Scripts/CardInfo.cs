...
public static class ID
{
    ...
    public const string COWBOY_LEGS = "Cowboy Legs";
    public const string COWBOY_TORSO = "Cowboy Torso";
    public const string COWBOY_HAT = "Cowboy Head";

    public const string GOTH_FEET = "Goth Feet";
    public const string GOTH_LEGS = "Goth Legs";
    public const string GOTH_TORSO = "Goth Torso";
